...
class CalWin(QWidget):
    ...
    def unitUI(self):
        ...
        self.layout.addWidget(QLabel("Nome: Cálcio"), 0, 1)
        self.layout.addWidget(QLabel('Distribuição Eletrônica: 1s² 2s² 2p⁶ 3s² 3p⁶ 4s²'), 1, 1)
        self.layout.addWidget(QLabel('Protões/Eletrões: 20'),2, 1)
        self.layout.addWidget(QLabel('Uso: Essencial para ossos e dentes, utilizado em cimento e em ligas metálicas'),3, 1)
