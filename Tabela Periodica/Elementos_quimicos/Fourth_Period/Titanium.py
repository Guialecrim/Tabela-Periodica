...
class TitWin(QWidget):
    ...
    def unitUI(self):
        ...
        self.layout.addWidget(QLabel("Nome: Titânio"), 0, 1)
        self.layout.addWidget(QLabel('Distribuição Eletrônica: 1s² 2s² 2p⁶ 3s² 3p⁶ 4s² 3d²'), 1, 1)
        self.layout.addWidget(QLabel('Protões/Eletrões: 22'),2, 1)
        self.layout.addWidget(QLabel('Uso: Utilizado em implantes médicos, ligas resistentes à corrosão e na indústria aeroespacial'),3, 1)
