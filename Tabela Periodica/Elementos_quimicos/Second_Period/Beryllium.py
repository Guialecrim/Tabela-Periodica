...
class BerWin(QWidget):
    ...
    def unitUI(self):
        ...
        self.layout.addWidget(QLabel("Nome: Berílio"), 0, 1)
        self.layout.addWidget(QLabel("Distribuição Eletrônica: 1s² 2s²"), 1, 1)
        self.layout.addWidget(QLabel('Protões/Eletrões: 4'),2, 1)
        self.layout.addWidget(QLabel('Uso: Utilizado na fabricação de componentes de ligas leves, janelas de raios X e como moderador em reatores nucleares'),3, 1)
