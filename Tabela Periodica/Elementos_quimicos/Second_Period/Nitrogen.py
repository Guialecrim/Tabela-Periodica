...
class NitWin(QWidget):
    ...
    def unitUI(self):
        ...
        self.layout.addWidget(QLabel("Nome: Nitrogênio"), 0, 1)
        self.layout.addWidget(QLabel('Distribuição Eletrônica: 1s² 2s² 2p³'), 1, 1)
        self.layout.addWidget(QLabel('Protões/Eletrões: 7'),2, 1)
        self.layout.addWidget(QLabel('Uso: Utilizado na produção de amônia, em fertilizantes e como gás inerte em soldagem'),3, 1)
