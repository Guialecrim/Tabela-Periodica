...
class ArgWin(QWidget):
    ...
    def unitUI(self):
        ...
        self.layout.addWidget(QLabel("Nome: Árgon"), 0, 1)
        self.layout.addWidget(QLabel('Distribuição Eletrônica: 1s² 2s² 2p⁶ 3s² 3p⁶'), 1, 1)
        self.layout.addWidget(QLabel('Protões/Eletrões: 18'),2, 1)
        self.layout.addWidget(QLabel('Uso: Utilizado em lâmpadas incandescentes e como gás de proteção em soldagem'),3, 1)
