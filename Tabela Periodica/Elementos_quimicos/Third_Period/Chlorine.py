...
class ChlWin(QWidget):
    ...
    def unitUI(self):
        ...
        self.layout.addWidget(QLabel("Nome: Cloro"), 0, 1)
        self.layout.addWidget(QLabel('Distribuição Eletrônica: 1s² 2s² 2p⁶ 3s² 3p⁵'), 1, 1)
        self.layout.addWidget(QLabel('Protões/Eletrões: 14'),2, 1)
        self.layout.addWidget(QLabel('Uso: Utilizado na purificação de água, em produtos de limpeza e na produção de PVC'),3, 1)
