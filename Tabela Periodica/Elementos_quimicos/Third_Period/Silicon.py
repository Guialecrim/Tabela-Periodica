...
class SilWin(QWidget):
    ...
    def unitUI(self):
        ...
        self.layout.addWidget(QLabel("Nome: Silício"), 0, 1)
        ...
        self.layout.addWidget(QLabel('Uso: Utilizado em eletrônicos, semicondutores e na fabricação de vidro'),3, 1)
