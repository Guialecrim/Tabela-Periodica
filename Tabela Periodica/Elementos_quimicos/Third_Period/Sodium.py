...
class SodWin(QWidget):
    ...
    def unitUI(self):
        ...
        self.layout.addWidget(QLabel("Nome: Sódio"), 0, 1)
        self.layout.addWidget(QLabel('Distribuição Eletrônica: 1s² 2s² 2p⁶ 3s¹'), 1, 1)
        self.layout.addWidget(QLabel('Protões/Eletrões: 11'),2, 1)
        self.layout.addWidget(QLabel('Uso: Utilizado em sal de cozinha (NaCl), em indústrias químicas e como refrigerante em reatores nucleares'),3, 1)
